# -*- coding: utf-8 -*-
"""fetch_retrogrades_aspects.ipynb
...
weekly_forecast = fetch_weekly_forecast(start_date)
...
save_to_json({"weekly_forecast": weekly_forecast})

# Print the fetched data for verification
print(json.dumps({"weekly_forecast": weekly_forecast}, indent=4))
